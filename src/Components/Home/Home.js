        ...
        <div>
            ...
            <div className="split-div body-section">
                <div className="split-content image-content">
                    <img src="https://i.ytimg.com/vi/XgPZrEHPKkk/maxresdefault.jpg" className="about-picture" alt="MescPT" />
                </div>
                <div className="split-content text-content">
                    <h2>About MescPT</h2>
                    <p>MescPT LLC, is based in Newark, Delaware, offering in-person training, online coaching and nutrition guidance, and pre-made workout programs for a cheaper entry point</p>
                </div>
            </div>
        </div>
    )
